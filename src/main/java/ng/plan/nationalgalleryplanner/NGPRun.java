...
public class NGPRun extends Application {
    ...
    public static class RoomStore {
        ...
        public void createRooms(){  //one time method to create all Rooms
            room1=new GraphNodeAdjList<>(new Room("Room 1","1","The Credit Suisse Exhibition: Raphael","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/raphael-image.jpg").toURI().toString())));
            room2=new GraphNodeAdjList<>(new Room("Room 2","2","The Credit Suisse Exhibition: Raphael","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/raphael-image.jpg").toURI().toString())));
            room4=new GraphNodeAdjList<>(new Room("Room 4","4","The Credit Suisse Exhibition: Raphael","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/raphael-image.jpg").toURI().toString())));
            room5=new GraphNodeAdjList<>(new Room("Room 5","5","The Credit Suisse Exhibition: Raphael","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/raphael-image.jpg").toURI().toString())));
            room6=new GraphNodeAdjList<>(new Room("Room 6","6","The Credit Suisse Exhibition: Raphael","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/raphael-image.jpg").toURI().toString())));
            room7=new GraphNodeAdjList<>(new Room("Room 7","7","The Credit Suisse Exhibition: Raphael","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/raphael-image.jpg").toURI().toString())));
            room8=new GraphNodeAdjList<>(new Room("Room 8","8","The Credit Suisse Exhibition: Raphael","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/raphael-image.jpg").toURI().toString())));
            room9=new GraphNodeAdjList<>(new Room("Room 9","9","Venice 1530-1600","enetian painting in this period was dominated by Titian (Tiziano) and three family workshops, active both locally and internationally: those of Jacopo Tintoretto, Paolo Veronese and Jacopo Bassano. Veronese was renowned for his harmonious and decorative colour and brilliant illusionistic effects. His paintings won Titian’s praise and he attracted many commissions from the Venetian state, including paintings for the Doge’s Palace.\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/venice-image.jpg").toURI().toString())));
            room10=new GraphNodeAdjList<>(new Room("Room 10","10","The sacred and profane in sixteenth-century Italian art","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room10-image.jpg").toURI().toString())));
            room11=new GraphNodeAdjList<>(new Room("Room 11","11","Veronese's 'Four Allegories of Love' ","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room11-image.jpg").toURI().toString())));
            room12=new GraphNodeAdjList<>(new Room("Room 12","12","Northern Italian Portraiture 1510–1580","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room12-image.jpg").toURI().toString())));
            room14=new GraphNodeAdjList<>(new Room("Room 14","14","The Netherlands","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room14-image.jpg").toURI().toString())));
            ...
            room15=new GraphNodeAdjList<>(new Room("Room 15","15","","Room 15 is part of art route B and links Room 9 with Room 18 (Rubens) and on to our Dutch paintings including works by and Rembrandt and Van Dyck.",
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room15-image.jpg").toURI().toString())));
            room15s=new GraphNodeAdjList<>(new Room("Room 15 Stairs","15s","","", new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room15-image.jpg").toURI().toString())));
            room16=new GraphNodeAdjList<>(new Room("Room16","16","Cranach the Elder, Huber and Seisenegger","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room16-image.jpg").toURI().toString())));
            room17=new GraphNodeAdjList<>(new Room("Room 17","17","Altdorfer, Rottenhammer, Wertinger","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room17-image.jpg").toURI().toString())));
            room17a=new GraphNodeAdjList<>(new Room("Room 17a","17a","Pastel in the 18th and 19th centuries","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room17a-image.jpg").toURI().toString())));
            room18=new GraphNodeAdjList<>(new Room("Room 18","18","Rubens","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room18-image.jpg").toURI().toString())));
            room19=new GraphNodeAdjList<>(new Room("Room 19","19","Dutch landscapes","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room19-image.jpg").toURI().toString())));
            room20=new GraphNodeAdjList<>(new Room("Room 20","20","A different view of Flanders","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room20-image.jpg").toURI().toString())));
            room21=new GraphNodeAdjList<>(new Room("Room 21","21","Van Dyck","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room21-image.jpg").toURI().toString())));
            room22=new GraphNodeAdjList<>(new Room("Room 22","22","Rembrandt","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room22-image.jpg").toURI().toString())));
            room23=new GraphNodeAdjList<>(new Room("Room 23","23","Dutch portraiture","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room23-image.jpg").toURI().toString())));
            room24=new GraphNodeAdjList<>(new Room("Room 24","24","International ambitions ","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room24-image.jpg").toURI().toString())));
            room25=new GraphNodeAdjList<>(new Room("Room 25","25","A New Art For A New Nation (2)","Room 25 expands on the theme of Room 28; displaying prime examples of what were newly independent artistic genres, including landscape, still life, portraiture and scenes of 17th-century Dutch domestic life.",
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room25-image.jpg").toURI().toString())));
            room26=new GraphNodeAdjList<>(new Room("Room 26","26","Brueghel the Elder, van der Heyden, van de Velde","",
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room26-image.jpg").toURI().toString())));
            room27=new GraphNodeAdjList<>(new Room("Room 27","27","de Hooch, Saenredam, Vermeer","",
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room27-image.jpg").toURI().toString())));
            room28=new GraphNodeAdjList<>(new Room("Room 28","28","A New Art For A New Nation (1)","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room28-image.jpg").toURI().toString())));
            room29=new GraphNodeAdjList<>(new Room("Room 29","29","French Painting 1600–1700 ","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room29-image.jpg").toURI().toString())));
            room30=new GraphNodeAdjList<>(new Room("Room 30","30","Spain","Spanish painting flourished during the 17th century principally in the service of God and King. The evolution of a Catholic Counter-Reformation religiosity is revealed in a variety of powerful, individual styles. Not long after El Greco had portrayed the divine with ethereal idealisations of figures, space and light, Diego Velázquez and Francisco de Zurbarán turned to realism to represent the mystical.\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room30-image.jpg").toURI().toString())));
            ...
            room32=new GraphNodeAdjList<>(new Room("Room 32","32","17th-century Italian paintings","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room32-image.jpg").toURI().toString())));
            room33=new GraphNodeAdjList<>(new Room("Room 33","33","David, Fragonard and Vernet","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room33-image.jpg").toURI().toString())));
            room34=new GraphNodeAdjList<>(new Room("Room 34","34","Constable, Turner and Stubbs","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room34-image.jpg").toURI().toString())));
            room35=new GraphNodeAdjList<>(new Room("Room 35","35","Hogarth and British Painting","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room35-image.jpg").toURI().toString())));
            room36=new GraphNodeAdjList<>(new Room("Room 36","36","Claude and Turner","Two works by the 19th-century English painter Turner are hung in this room with two by the 17th-century French landscape painter Claude, in accordance with Turner’s will.\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room36-image.jpg").toURI().toString())));
            room37=new GraphNodeAdjList<>(new Room("Room 37","37","The Grand Tour","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room37-image.jpg").toURI().toString())));
            room38=new GraphNodeAdjList<>(new Room("Room 38","38","Canaletto and Guardi","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room38-image.jpg").toURI().toString())));
            room39=new GraphNodeAdjList<>(new Room("Room 39","39","Canaletto, Pittoni, and Tiepolo","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room39-image.jpg").toURI().toString())));
            room40=new GraphNodeAdjList<>(new Room("Room 40","40","18th-century painting in Europe","During the 18th century it was common for artists to travel, both to seek inspiration and embrace opportunity. Claude-Joseph Vernet was the most celebrated French view painter of the period. In 1734 he relocated to Rome, where he spent almost 20 years and earned an international reputation. Vernet’s view paintings (or ‘vedute’) were particularly sought after by travellers on the and European rulers. His contrasting pair of paintings, A Landscape at Sunset and A Shipwreck in Stormy Seas, were originally commissioned for the King of Poland, Stanislaus Augustus Poniatowski (1732–1798), whose official court painter at the time was Bernardo Bellotto. Having trained with his uncle Canaletto in Venice, Bellotto went on to enjoy a successful career at the royal courts in Dresden, Vienna, Munich and Warsaw, glorifying the great capitals of Europe through his highly original topographical views.",
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room40-image.jpg").toURI().toString())));
            room41=new GraphNodeAdjList<>(new Room("Room 41","41","Cézanne, Monet, Renoir","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room41-image.jpg").toURI().toString())));
            room42=new GraphNodeAdjList<>(new Room("Room 42","42","Room Closed","This room is currently closed to visitors.",null));
            room43=new GraphNodeAdjList<>(new Room("Room 43","43","Gauguin, Seurat, Van Gogh","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room43-image.jpg").toURI().toString())));
            room44=new GraphNodeAdjList<>(new Room("Room 44","44","Cézanne, Degas, Monet","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room44-image.jpg").toURI().toString())));
            room45=new GraphNodeAdjList<>(new Room("Room 45","45","Constable, Corot and Ingres","",new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room45-image.jpg").toURI().toString())));
            ...
            room51=new GraphNodeAdjList<>(new Room("Room 51","51","Italy, 1250–1350","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room51-image.jpg").toURI().toString())));
            room51a=new GraphNodeAdjList<>(new Room("Room 51a","51a","Fra Angelico, friar-painter of San Domenico","\n" +
                    ...
                    ,new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room51a-image.jpg").toURI().toString())));
            room52=new GraphNodeAdjList<>(new Room("Room 52","52","Siena, 1300–1450","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room52-image.jpg").toURI().toString())));
            room53=new GraphNodeAdjList<>(new Room("Room 53","53","Florence and Beyond, 1440–1470","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room53-image.jpg").toURI().toString())));
            room54=new GraphNodeAdjList<>(new Room("Room 54","54","Mantegna and Crivelli","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room54-image.jpg").toURI().toString())));
            room55=new GraphNodeAdjList<>(new Room("Room 55","55","Venice and the Veneto, 1460–1510","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room55-image.jpg").toURI().toString())));
            room56=new GraphNodeAdjList<>(new Room("Room 56","56","Venice after 1500","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room56-image.jpg").toURI().toString())));
            room57=new GraphNodeAdjList<>(new Room("Room 57","57","Ferrara and Bologna","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room57-image.jpg").toURI().toString())));
            room58=new GraphNodeAdjList<>(new Room("Room 58","58","Botticelli and Filippino Lippi","Sandro Botticelli was among the most sought-after painters in his native Florence in the last three decades of the fifteenth century. A versatile and creative artist, he produced paintings of many types from large scale altarpieces and mythological scenes, to smaller devotional images and portraits. Filippino Lippi was the son of Botticelli’s teacher, Fra Filippo Lippi. Following the death of his father when he was still a boy, Filippino entered Botticelli’s workshop. \n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room58-image.jpg").toURI().toString())));
            room59=new GraphNodeAdjList<>(new Room("Room 59","59","Florence, 1460–1500","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room59-image.jpg").toURI().toString())));
            room60=new GraphNodeAdjList<>(new Room("Room 60","60","Florentine Altarpieces about 1350 – about 1460 ","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room60-image.jpg").toURI().toString())));
            room61=new GraphNodeAdjList<>(new Room("Room 61","61","Central Italy, 1480–1520","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room61-image.jpg").toURI().toString())));
            room62=new GraphNodeAdjList<>(new Room("Room 62","62","Cologne and north-western Germany","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room62-image.jpg").toURI().toString())));
            room63=new GraphNodeAdjList<>(new Room("Room 63","63","15th-century Netherlandish painting","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room63-image.jpg").toURI().toString())));
            room64=new GraphNodeAdjList<>(new Room("Room 64","64","Beyond the Netherlands","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room64-image.jpg").toURI().toString())));
            room65=new GraphNodeAdjList<>(new Room("Room 65","65","Southern Germany and Austria","Painters in southern German and Austria collaborated with sculptors to produce spectacular large altarpieces with moveable shutters. One of the greatest specialists in such work was Michael Pacher from the Tyrol. The small devotional painting of the Virgin and Saints attributed to him reflects the daring illusionistic effects he achieved in large-scale altarpieces.\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room65-image.jpg").toURI().toString())));
            room66=new GraphNodeAdjList<>(new Room("Room 66","66","Leonardo da Vinci at the National Gallery","\n" +
                    ...
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/room66-image.jpg").toURI().toString())));
            ...
            roomVestibule=new GraphNodeAdjList<>(new Room("Main Vestibule","MV","Main Vestibule","The Main Vestibule, just beyond the Portico entrance, leads up the stairs to Central Hall, Room 1 and the galleries on the main floor. Boris Anrep's mosaics were added in the 1920s and 30s, depicting leading figures of the day as characters from mythology.",
                    new Image(new File("src/main/java/ng/plan/nationalgalleryplanner/roomImages/roomMV-image.jpg").toURI().toString())));
